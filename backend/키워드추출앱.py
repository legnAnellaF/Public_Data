...
STOPWORDS = {
    ...
    "위해", "대한", "관련", "기반", "특정", "사용자", "입력", "문장", "프롬포트", "프롬프트",
    "정보", "내용", "방법", "기능", "결과", "화면", "파일", "저장", "있는", "없는", "하고",
    "하는", "한다", "된다", "싶다", "만들고", "만드는", "만들", "있다", "으로", "에서",
    "에게", "부터", "까지", "보다", "처럼", "통해", "알려줘", "알려주세요", "보여줘", "보여주세요",
    "찾아줘", "찾아주세요", "현재", "지금", "알고", "싶어", "주세요", "궁금해",
    "나", "내가", "저", "저는", "제가", "우리", "우리가", "내", "제", "방금", "요즘", "최근",
    "근데", "그런데", "그래서", "혹시", "만약", "인데", "하는데", "중인데", "중이야", "중입니다",
    "지나가", "지나가는", "가는중", "이동중", "타려고", "하려고", "알고싶어", "궁금합니다",
    "보고싶어", "확인하고싶어", "확인", "볼만한", "있을까", "있을까요", "있나요",
...
NOISE_PHRASES = (
    ...
    "중인데", "중이야", "중입니다", "알고싶어", "궁금합니다", "궁금해", "알려주세요",
    "알려줘", "보고싶어", "확인하고싶어", "볼만한", "타려고", "하려고", "있을까요",
    "있을까", "있나요", "지금", "현재", "방금", "요즘", "최근",
    "내가", "제가", "저는", "우리가", "우리", "근데", "그런데", "그래서", "혹시", "만약",
    "하는데", "인데", "오전", "오후", "구매할거야", "구매할거", "구매", "살거야",
    "사려고", "얼마인지", "얼마", "인지", "확인",
)
...
def parse_solar_keywords(content):
...
def analyze_query(text):
    solar_keywords = analyze_with_solar(text)
    if solar_keywords:
...
def analyze_intent(text):
    """Backend-friendly result for API responses."""
...
if __name__ == "__main__":
    samples = [
        "오늘 오후에 sk하이닉스 주식을 구매할거야. 지금 하이닉스 주식이 얼마인지 확인하고싶어",
